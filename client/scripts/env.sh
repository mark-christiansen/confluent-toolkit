...
dst() {
    ...
    export RBAC="false"
    export SASL="false"
    export BROKER_URL="lb.${DOMAIN}:29096"
...
src() {
    ...
    export RBAC="false"
    export SASL="false"
    export BROKER_URL="lb.${DOMAIN}:29092"
...
token() {
    ...
    export RBAC="true"
    export SASL="true"
    export BROKER_URL="lb.${DOMAIN}:19092"
...
gssapi() {
    echo "Setting \"gssapi\" environment variables"
    export SSL="true"
    export RBAC="true"
    export SASL="true"
...
gssapi_client() {
    echo "Setting \"gssapi_client\" environment variables"
    export SSL="true"
    export RBAC="true"
    export SASL="true"
    export KERBEROS="true"
    export BROKER_URL="kafka1.${DOMAIN}:29093,kafka2.${DOMAIN}:29094,kafka3.${DOMAIN}:29095"
    export KAFKA_CONFIG="/scripts/config/gssapi_client.config" 
    export KEYSTORE_DIR="/var/ssl/private"
    export KEYSTORE_PASSWORD="serverpassword"
    export ZOO1_URL="zoo1.${DOMAIN}:2181"
    export ZOO2_URL="zoo2.${DOMAIN}:2182"
...
gssapi_client_local() {
    echo "Setting \"gssapi_client_local\" environment variables"
    export SSL="true"
    export RBAC="true"
    export SASL="true"
    export KERBEROS="true"
    export BROKER_URL="localhost:9093,localhost:9094,localhost:9095"
    export KAFKA_CONFIG="../config/gssapi_client_local.config" 
    export KEYSTORE_DIR="../../../certs"
    export KEYSTORE_PASSWORD="serverpassword"
    export ZOO1_URL="localhost:2181"
    export ZOO2_URL="localhost:2182"
