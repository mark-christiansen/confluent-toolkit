...
export SCHEMA_REGISTRY_OPTS="-Djavax.net.ssl.trustStore=$KEYSTORE_DIR/kafka1.kafka_network.truststore.jks -Djavax.net.ssl.trustStorePassword=$KEYSTORE_PASSWORD"
