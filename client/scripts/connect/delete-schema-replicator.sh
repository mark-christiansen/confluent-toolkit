...
echo "Deleting schema replicator connector"
curl -k $BASIC_AUTH --header "Content-Type: application/json" -X DELETE $KAFKA_CONNECT_URL/connectors/schemarepl
echo "Deleted schema replicator connector"